...
Local changes are limited to provider placement and the Codex hook command path, which points to the repository-local `.agents/skills/impeccable/scripts/hook.mjs`. Product-specific workflow and context files are original project documentation.
