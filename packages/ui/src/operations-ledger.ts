...
.app-shell .workspace{inline-size:100%;max-inline-size:100rem;min-inline-size:0}
...
.app-shell .shell-main :is(.modg-page,.modg-int,.modg-saas){min-inline-size:0;max-inline-size:100%;color:var(--ink);background:transparent}
...
.app-shell .shell-main .modg-page .modg-hero .modg-eyebrow,
.app-shell .shell-main .modg-int>header .modg-int-eyebrow,
.app-shell .shell-main .modg-saas>header .modg-saas-eyebrow{color:#f0d36d!important}
.app-shell .shell-main .modg-page section .modg-eyebrow,
.app-shell .shell-main .modg-int .modg-int-panel .modg-int-heading p,
.app-shell .shell-main .modg-saas :is(.modg-saas-subscription,.modg-saas-panel) .modg-saas-eyebrow{color:var(--accent-strong)!important;font-weight:850}
...
.app-shell .shell-main .modg-metric-grid{display:block;min-inline-size:0;border:1px solid var(--line);border-radius:var(--radius);overflow:hidden;background:var(--surface);margin-block-start:.8rem}
.app-shell .shell-main .modg-metric-grid .modg-metric{display:grid;grid-template-columns:minmax(12rem,.8fr) minmax(17rem,1.4fr) minmax(10rem,.65fr);min-inline-size:0;gap:1rem;align-items:center;border:0;border-block-end:1px solid var(--line);border-radius:0;background:transparent;padding:.9rem 1rem}
...
.app-shell .shell-main .modg-metric-grid .modg-metric dl{grid-template-columns:repeat(2,minmax(0,1fr));min-inline-size:0;margin:0}
.app-shell .shell-main .modg-metric-grid .modg-metric dl>div{min-inline-size:0;overflow-wrap:anywhere}
...
.app-shell .shell-main .modg-saas-subscription dl div small{color:var(--muted)!important}
...
.app-shell .shell-main .modg-page .modg-tabs a{min-block-size:44px;display:inline-flex;align-items:center;color:var(--ink-soft)!important}
.app-shell .shell-main .modg-page .modg-tabs a[aria-current=page]{background:var(--accent-soft)!important;border-color:var(--accent)!important;color:var(--accent-strong)!important;font-weight:800}
.app-shell .shell-main .modf-tabs a{min-block-size:44px;display:inline-flex;align-items:center}
.app-shell .shell-main :is(.modg-badge,.modg-int-badge,.modg-saas-badge){border-radius:999px!important;background:#e9ece9!important;color:var(--ink-soft)!important;font-weight:800}
.app-shell .shell-main :is(.modg-badge--fresh,.modg-badge--success,.modg-badge--completed,.modg-badge--low,.modg-int-badge--active,.modg-int-badge--clear,.modg-saas-badge--active,.modg-saas-badge--completed,.modg-saas-badge--enabled,.modg-saas-badge--resolved,.modg-saas-badge--low){background:var(--accent-soft)!important;color:var(--accent-strong)!important}
.app-shell .shell-main :is(.modg-badge--stale,.modg-badge--attention,.modg-badge--review,.modg-badge--medium,.modg-badge--queued,.modg-int-badge--degraded,.modg-int-badge--review,.modg-int-badge--paused,.modg-saas-badge--trial,.modg-saas-badge--past_due,.modg-saas-badge--queued,.modg-saas-badge--review,.modg-saas-badge--monitoring,.modg-saas-badge--medium,.modg-saas-badge--soft,.modg-saas-badge--observe){background:var(--attention-soft)!important;color:var(--attention)!important}
.app-shell .shell-main :is(.modg-badge--failed,.modg-badge--critical,.modg-badge--high,.modg-int-badge--revoked,.modg-saas-badge--suspended,.modg-saas-badge--cancelled,.modg-saas-badge--failed,.modg-saas-badge--critical,.modg-saas-badge--high,.modg-saas-badge--revoked){background:var(--danger-soft)!important;color:var(--danger)!important}
.app-shell .shell-main :is(.modg-badge--running,.modg-badge--rebuilding,.modg-saas-badge--running,.modg-saas-badge--investigating){background:#e8edf0!important;color:#263d49!important}
.app-shell .shell-main :is(.modg-metric__footer,.modg-list,.modg-int-panel,.modg-saas-panel) a{color:var(--accent-strong)!important;font-weight:800;text-underline-offset:3px}
...
@media(max-width:900px){
  .app-shell .shell-main .modg-metric-grid .modg-metric dl{grid-template-columns:minmax(0,1fr)}
}
