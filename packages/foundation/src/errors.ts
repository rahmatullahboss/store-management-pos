export type ErrorCode =
  ...
  | "NOT_FOUND" | "CONFLICT" | "IDEMPOTENCY_CONFLICT" | "VERSION_CONFLICT" | "APPROVAL_REQUIRED"
  | "RATE_LIMITED" | "DATABASE_UNAVAILABLE" | "IDENTITY_PROVIDER_UNAVAILABLE" | "INTERNAL_ERROR";
