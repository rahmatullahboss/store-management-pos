...
test("persistent staging uses a dedicated Neon project instead of generic disposable preview capacity", async () => {
  ...
  assert.match(policy, /agent\/internal-token-durable-journal/u);
  assert.match(policy, /agent\/internal-token-journal-command-boundary/u);
  assert.match(policy, /agent\/internal-token-journal-authoritative-history/u);
  assert.match(policy, /agent\/internal-token-provider-signing-receipt/u);
  assert.match(policy, /agent\/internal-token-provider-signing-journal/u);
  assert.match(policy, /agent\/internal-token-provider-evidence-custody/u);
  assert.match(policy, /agent\/internal-token-provider-evidence-disposition/u);
  assert.match(policy, /agent\/internal-token-production-launch-admission/u);
  assert.match(policy, /agent\/internal-token-provider-operational-gate/u);
  ...
  assert.match(policy, /agent\/internal-token-production-attestation-receipt-postgres/u);
