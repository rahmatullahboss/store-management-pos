...
.moda-shell{--moda-ink:var(--ink,#17231e);--moda-muted:var(--muted,#59675f);--moda-paper:var(--paper,#f5f3ec);--moda-panel:var(--surface,#fffefa);--moda-line:var(--line,#d7ddd8);--moda-deep:var(--rail,#14251e);--moda-accent:var(--accent,#1f6a51);--moda-warn:var(--attention,#8a5a00);--moda-danger:var(--danger,#9b2c2c);--moda-info:#245f80;--moda-radius:var(--radius,14px);color:var(--moda-ink);background:var(--moda-paper);font-family:ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;line-height:1.45;min-height:100%;padding:24px}
