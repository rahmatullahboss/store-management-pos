...
if ((requested.has("MOD-B-INVENTORY") || requested.has("MOD-B-PROCUREMENT")) && !requested.has("FOUNDATION")) throw new Error("MOD-B migrations require FOUNDATION");
if (requested.has("MOD-B-PROCUREMENT") && !requested.has("MOD-B-INVENTORY")) throw new Error("MOD-B-PROCUREMENT requires MOD-B-INVENTORY");
