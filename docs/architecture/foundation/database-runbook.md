...
2. Apply `FND-0001`, `FND-0002`, then `FND-0003` from `database/foundation/manifest.json`.
...
5. Run tenant-isolation, idempotency, outbox/inbox and reference-slice checks.
